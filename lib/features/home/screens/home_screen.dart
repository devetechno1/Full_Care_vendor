        ...
        child: SingleChildScrollView(
          ...
          child: GetBuilder<ProfileController>(builder: (profileController) {
            return Column(children: [
              ...
              profileController.modulePermission != null && profileController.modulePermission!.wallet! && !isEmployee && profileController.profileModel?.subscriptionTransactions != true ? GestureDetector(
